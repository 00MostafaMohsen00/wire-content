    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('email')->copyable()->copyMessage('Email Copied To Clipboard')->searchable(),
                // SelectColumn::make('roles')->multiple()->relationship('roles', 'name')->preload()->searchable(),
